...
namespace ShopManager.Controllers
{
    public class ProductController : Controller
    {
        ...
        //View Search
        public IActionResult Search(string searchString, int page = 1, string sortOrder = "")
        {
            //Khai báo số lượng Row trong 1 trang
            int pageSize = 8;
            ...
            // Lấy danh sách Product sau khi phân trang
            List<Product> products = new List<Product>();
            products = productDAL.GetProducts_Search(searchString, page, pageSize, sortOrder);

            //Lấy tổng số lượng Product
            int rowCount = productDAL.CountRows_Search(searchString);
